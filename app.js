...
Alarm = function() {
  ...
  alarm.controller = function() {
    ...
    ringAlarm = function() {
      return window.open(ctrl.link(), '_blank');
    };
    ctrl.timeSelected = function(value) {
      var hours, minutes, ref, val;
      val = moment();
      ...
      return window.setTimeout(ringAlarm, val - (+moment()));
    };
  ...
  alarm.view = function(ctrl) {
    return m('body', [
      m('h1', ctrl.currentTime.format('LLL')), m('label', 'Alarm time'), m('input[type=time]', {
        onblur: m.withAttr('value', ctrl.timeSelected)
      }), m('label', 'Link'), m('input[type=text]', {
        oninput: m.withAttr('value', ctrl.link)
      }), ctrl.timeToAlarm ? m('h3', ctrl.timeToAlarm + " to alarm") : void 0
    ]);
  };
  return alarm;
};
